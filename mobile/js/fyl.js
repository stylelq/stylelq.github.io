...
var text1 = "<b>Shape.Shifter 쉐이프 쉬프터는</b><br/>신화나 소설 속에서 <b>형태가 변신하는 능력자를</b><br>의미하며 이야기 속에서 <b>물리적인 모양을<br>변신하는 능력은</b> 초인간적인 능력, 신의 개입,<br>악마의 조작, 마법과 주문 같은 초월의 능력으로<br>가능했습니다.<br>역사적으로 누적된 수많은 설화와 사례들은<br>고정된 모습을 전복하려는 인간의 모양 변신에 대한<br>욕망을 투사합니다.<br>Find Your Light 3는 루이까또즈의 헤리티지인<br>가방이 가지고 있는 원형의 한계를 뛰어 넘어 가방에<br>물리적 변형을 가하며 자유롭게 창작하는 프로젝트<br>입니다.<br>10인의 아티스트와 함께 패션과 미술의<br>혼성적 경계에서 새로운 차원의 감각을 추구하며<br>동시대 예술의 가능성을 탐험합니다.";
var yangseoungbin = "양승빈은 전통적 공예와 스토리텔링을 활용해<br/>오브제를 창작하는 디자이너입니다.<br/>네덜란드의 디자인 아카데미 에인트호번에서<br/>Public Private과 Contextual Design 과정을 졸업한<br/>이래 에인트호번과 서울을 오가며 활동을<br/>" + "이어가고 있습니다.<br/>전통적인 옻칠 기법을 다양한 물성에 적용하는<br/>리서치를 기반으로 한 ‘21g’ 시리즈에서<br/>‘Lacquered Forms’와 ‘Simulacre’ 시리즈로 점차 작업<br/>을 확장하고 있습니다.<br/>" + "작가의 작품 ‘Simulacre’ 시리즈는 영국 V&A<br/>뮤지엄과 네덜란드 스테델릭 미술관에 영구 소장 중<br/>입니다. 최근에는 작가 자신의 스토리텔링을 기반으<br/>로 고고학적 허구를 오브젝트에 결합한 작업<br/>‘Requiem’을 진행 중입니다.<br/><br/>" + "양승빈은 디지털 이미지가 전송되고 복제되는<br/>과정에서 이미지가 기존의 인식과 다른 낯선 모습으<br/>로 열화되는 디지털 변형 현상에 주목했습니다.<br/> " + "&lt;Deconstructed Icons&gt;는 루이까또즈 제품을 찍은<br/>2D 이미지를 다시 3D 디지털 이미지로 치환하고<br/>디지털 상에서 ‘조각내기’와 ‘붙이기’를 반복해<br/>해체-변형-재조합을 시도한 결과입니다.<br/>관습적인 맥락에서 대상을 분리한 시각적 변형은<br/>" + "우리에게 친숙한 루이까또즈 가방을<br/>이질적이면서도 기이한 디지털적 심미성을 가진<br/>오브제로 변화시킵니다. ";
var isVisible = false;
