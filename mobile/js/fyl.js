...
var choisujin = "최수진은 여러 종류의 광물을 이용해 사물의 존재<br>양상을 재현하고 연출합니다.<br>작가의 관점으로 번역되어 현실에 재구축되는<br>덩어리들은 물질과 작품의 간극을 넘나들며<br>" + "실재에 대한 열망을 드러냅니다.<br>때로는 너무 많은 사물에 권태와 사랑을 동시에<br>느끼며 2022년 현재 서울에 위치한 작업실 물질세계<br>에서 작품활동을 이어가고 있습니다.<br><br>" + "최수진의 &lt;Objects of Lumps&gt;는 전형적인 가방의<br>형상을 유연하고 꾸덕한 물질로 치환했습니다.<br>가방의 몸통은 가로와 세로 방향으로<br>확장되며 변형되고, 은색의 구슬로 " + "변환된 체인은 가<br>방에서 떨어져 나와 간신히 몸통에 걸쳐쳤습니다.<br>여분의 물질들은 덩어리가 되어 주변에 흩어졌습니<br>다.<br>검고 꾸덕한 조각이 되어버린 가방들" + "은 표면의<br>금속 부자재의 흔적만이 남아 그들이 가방이었음을<br>간신히 말해줍니다.<br>각각의 덩어리가 하나로 모여 있는 모습은 어느 조각<br>공원의 전경처럼 공간에 묵직" + "하게 존재합니다. ";
var isVisible = false;
