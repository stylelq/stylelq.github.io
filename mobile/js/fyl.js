...
var yeonjinyoung = "연진영의 작업은 산업용 기자재나 폐기물을 활용해<br>가구 디자인이라는 방법론을 우회해 조각으로 귀결<br>됩니다. 재고로 남은 패딩, 산업용 앵글, 덕트처럼<br>" + "다양한 재료들을 활용해 통상적으로 재료가<br>수행하는 역할을 배제하고 재료가 가진 물성을<br>재해석해 새로운 가치를 부여하는 작업을 합니다.<br>" + "이 과정에서 새로운 시도와 고유한 물성의 차이가<br>만들어 내는 모호하고 불안정한 다중의 경계들을<br>미적으로 형상화하는 데 의미를 둡니다.<br><br>" + "연진영은 재고로 남은 구스 다운 쟈켓, 망가진 농구공,<br>변형된 알루미늄 파이프 등 기존 사물이 가진 물성을<br>변주해 가방의 형태를 가진 새로운 오브제를 창조했<br>습니다.<br>" + "<span>Padded Bag</span>은 시제품, 사소한 결함, 과잉생산으로 폐<br>기만을 남겨준 구스 다운 쟈켓에 기능을 부여해 사물<br>의 지속가능성에 대해 이야기합니다.<br>" + "<span>Basketball Bag</span>은 스포츠 오브제인 농구공의 형태를<br>차용해 역동성을 가방에 부여하고 반투명한 소재의<br>적용을 통해 도발적이고 호기심을 자아냅니다.<br>" + "Pipe Bag은 변형이 쉬워 외부의 힘에 의해 망가지고<br>쉽게 붕괴되는 알루미늄 파이프로 완성했습니다.<br>" + "구부러진 파이프는 보편적인 형태와는 다른 낯설음<br>을 제공하고 사물의 새로운 면을 보게 합니다.";
var isVisible = false;
