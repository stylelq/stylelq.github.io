...
var kangjaewon = "김준수는 식물성 무두질된 가죽의 물질성과 상징성에 주목한 조형 작업을 전개해 왔습니다. 국민대학교에서 금속공예와 주얼리를 전공한 그는 이탈리아에서 참여한<br>" + "가죽 워크숍을 계기로 한국과 유럽을 중심으로 다양한 전시 활동을 이어가고 있습니다. 2019년 청주공예비엔날레의 우승작 공동 수상, 2022년 로에베 공예상 공모전에서<br>" + "파이널리스트로 선정되었습니다.<br><br>" + "김준수는 식물성 무두질된 가죽을 자신만의 기법으로 재해석한 조형 작업을 진행하고 있습니다. 전시대 위에 올려진 작품의 감상은 대부분 시각에 의존한 정보 습득과<br>" + "이해로 귀결됩니다. 가방의 형태를 작가만의 기법과 조형 감각으로 풀어낸 <span>Tactile Object</span>는 전시대 위에 놓인 오브제를 매개로 손의 적극적인 개입을 유도합니다.<br>" + "시각뿐 아니라 우리의 다양한 감각을 사용하여 작품을 느끼는 경험은 단순한 시각적 경험을 뛰어넘어 다채로운 감각을 이끄는 증폭제가 됩니다.";
var isVisible = false;
