...
var junghyunjee = "정현지는 네덜란드의 에인트호번에 거주하며 평면과 입체를 오가며 다양한 섬유 작업을 합니다. 최근에는 한국 고유의 전통 공예 기법과 명주를 이용한 섬유 작업을 전개하며 한국과 네널란드를 오가며 활동하<br>" + "고 있습니다. 서울 공예트렌드페어, 밀라노 페어, 더치디자인위크 등 다수의 공예·디자인 페어에 참가하였고, 서울 런던, 로테르담에 있는 갤러리를 통해 작업을 선보이고 있습니다.<br><br>" + "정현지는 평면과 입체를 오가며 다양한 섬유 작업을 전개해 왔습니다. <span>Leather Brick Series for a Bag</span>은 다소 평면적 소재로 인식된 가죽에 새로운 입체성을 부여했습니다. 가죽의 앞, 뒤, 옆면이 가진 서<br>" + "로 다른 재질과 색상에 주목하고 이를 교차시켜 재질의 속성을 강조했습니다. 얇은 가죽을 동일한 폭으로 자른 뒤 차곡차곡 쌓아 올려 각각의 가죽 벽돌을 만들고 다시 그것들을 하나의 구조로 쌓으며 가방의 형<br>" + "태를 완성했습니다. 벽돌을 쌓아서 건물을 구축하듯 하나의 기초가 되는 형태 요소를 반복-확장하며 평면에서 구조적 형태로 변화합니다.";
var isVisible = false;
