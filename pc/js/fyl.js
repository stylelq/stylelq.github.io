...
var yangseoungbin = "양승빈은 전통적 공예와 스토리텔링을 활용해 오브제를 창작하는 디자이너입니다. 네덜란드의 디자인 아카데미 에인트호번에서 Public Private과 Contextual<br>" + "Design 과정을 졸업한 이래 에인트호번과 서울을 오가며 활동을 이어가고 있습니다. 전통적인 옻칠 기법을 다양한 물성에 적용하는 리서치를 기반으로 한 ‘21g’ 시리<br>" + "즈에서 ‘Lacquered Forms’와 ‘Simulacre’ 시리즈로 점차 작업을 확장하고 있습니다. 작가의 작품 ‘Simulacre’ 시리즈는 영국 V&A 뮤지엄과 네덜란드 스테델릭 미술관<br>" + "에 영구 소장 중입니다.  최근에는 작가 자신의 스토리텔링을 기반으로 고고학적 허구를 오브젝트에 결합한 작업 ‘Requiem’을 진행 중입니다.<br><br>" + "양승빈은 디지털 이미지가 전송되고 복제되는 과정에서 이미지가 기존의 인식과 다른 낯선 모습으로 열화되는 디지털 변형 현상에 주목했습니다.<br>" + "&lt;Deconstructed Icons&gt;는 루이까또즈 제품을 찍은 2D 이미지를 다시 3D 디지털 이미지로 치환하고 디지털 상에서 ‘조각내기’와 ‘붙이기’를 반복해 해체-변형-재조합<br>" + "을 시도한 결과입니다. 관습적인 맥락에서 대상을 분리한 시각적 변형은 우리에게 친숙한 루이까또즈 가방을 이질적이면서도 기이한 디지털적 심미성을 가진<br>" + "오브제로 변화시킵니다."; // 최수진

var choisujin = "최수진은 여러 종류의 광물을 이용해 사물의 존재 양상을 재현하고 연출합니다. 작가의 관점으로 번역되어 현실에 재구축되는 덩어리들은 물질과 작품의 간극을 넘나<br>" + "들며 실재에 대한 열망을 드러냅니다. 때로는 너무 많은 사물에 권태와 사랑을 동시에 느끼며 2022년 현재 서울에 위치한 작업실 물질세계에서 작품활동을 이어가고<br>" + "있습니다.<br><br>" + "최수진의 &lt;Objects of Lumps&gt;는 전형적인 가방의 형상을 유연하고 꾸덕한 물질로 치환했습니다. 가방의 몸통은 가로와 세로 방향으로 확장되며 변형되고, 은색의 구<br>" + "슬로 변환된 체인은 가방에서 떨어져 나와 간신히 몸통에 걸쳐쳤습니다. 여분의 물질들은 덩어리가 되어 주변에 흩어졌습니다. 검고 꾸덕한 조각이 되어버린 가방들<br>" + "은 표면의 금속 부자재의 흔적만이 남아 그들이 가방이었음을 간신히 말해줍니다. 각각의 덩어리가 하나로 모여 있는 모습은 어느 조각공원의 전경처럼 공간에 묵직<Br>" + "하게 존재합니다. ";
var isVisible = false;
