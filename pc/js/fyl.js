...
window.addEventListener('scroll', function() {
    ...
    if ( checkVisible($('#contentText2')) && !isVisible) {
        var text2 = "루이까또즈는 젊은 아티스트와 함께 다양한 문화와 에너지를 공유하기 위한 Find Your Light 프로젝트를 2020년부터 이어가고 있습니다.  루이까또즈는 <br>" +
            "젊은 아티스트와 함께 다양한 문화와 에너지를 공유하기 위한 Find Your Light 프로젝트를 2020년부터 이어가고 있습니다.<br>" +
            "2022년 프로젝트 Shape.Shifter 쉐이프 쉬프터는 브랜드의 헤리티지인 가방이 가지고 있는 원형의 한계를 뛰어넘어 가방에 물리적 변형을<br>" +
            "가하며 자유롭게 창작하는 프로젝트입니다. <br><br>" +
            "컨트리뷰터스는 공예인 김은학과 공예·디자인 연구자 이정은이 결성한 제작문화 콜렉티브로 공예·디자인과 연결된 사회 현상, 역사, 인물, 지역 등에 대한<br>" +
            "포괄적인 리서치를 컨트리뷰터스는 공예인 김은학과 공예·디자인 연구자 이정은이 결성한 제작문화 콜렉티브로 역사, 인물, 지역 등에 대한<br>" +
