...
var yangsiyoung = "양시영은 베를린을 기반으로 컨셉추얼한 비주얼을 탐구하는 아티스트입니다. 소셜미디어 속에서 사람과 사물, 현실이 얽히고 설키며 가상세계와 상호작용하는 거대한 시각 이미지들을 관찰하며 디지털 자본주<br>" + "의에서 이미지가 지니는 의미와 상징성에 대한 연구를 하고 있습니다. '레플리카'를 방법론으로 삼아 이미 존재하는 디자인 아이콘을 불완전한 형태와 기능을 가진 이미지-오브제로 재창조하여 여러 다른 맥락<br>" + "에 배치함으로써 다양한 관점의 내러티브를 창조합니다.<br><br>" + "양시영 작가는 인터넷에 부유하는 루이까또즈의 디지털 이미지를 리소스 삼아 해체와 재해석을 통해 Fabricated Image Objects를 완성해습니다. 루이까또즈의 상징적인 패턴과 형태를 새로운 재료와 기<br>" + "법으로 복제하여 불완전한 형태와 기능을 지닌 상징적 오브젝트가 완성되었습니다. 일련의 작업을 통해 작가는 물리적 객체와 디지털 이미지 사이의 긴장감을 유발하고 이미지 소비의 순환에 새로운 기점을 제<br>" + "시합니다. Chain Jewelry Objects는 루이까또즈 가방의 체인을 디지털 이미지로 출력해 물리적인 조각으로 변신하였습니다. Floor Garment와 Chair Garment는 연출하는 방식에 따라 용도를 지<br>" + "니는 가먼트 혹은 비주얼 오브제로 존재하며 오브제 가먼트와 이미지 조각의 경계를 탐험합니다.";
var isVisible = false;
